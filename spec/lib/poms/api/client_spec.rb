  ...
  module Api
    RSpec.describe Client do
      ...
      it 'signs requests' do
        ...
        expect(signed_request['X-NPO-Date']).to eql('Tue, 19 Apr 2016 07:48:46 +0200')
        expect(signed_request['Authorization']).to eql('NPO mykey:SjeYLRMQ4W0hI8ZI8JAR6Y9sHUWxZAKA/vg/vlBCw9o=')
      end
